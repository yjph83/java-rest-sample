...
public class SwaggerConfiguration {
    ...
    /**
    此为方式二:通过.apis(RequestHandlerSelectors.basePackage("com.changhong.cloud.javarestsample.controller"))
    通过包形式来访问
     */
    @Bean
...
//                .paths(regex("/com/changhong/cloud/javarestsample/pojo/user.*"))
                .build();
    }
